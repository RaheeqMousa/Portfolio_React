            ...
            <div className={`d-flex gap-5 justify-content-center ${style.footer}`}>
                    ...
                    <div className='d-flex justify-content-center flex-column' >    
                        ...
                        <div className='d-flex align-content-center justify-content-center gap-3 px-5 ' >
                            <a href='#'><FaFacebook size={40} color='white' target='_blank' /></a>
                            <a href='#'><FaInstagram size={40}  color='white'target='_blank' /></a>
                            <a href='https://www.linkedin.com/in/raheeq-mousa-b960b7291/' target='_blank'><FaLinkedin size={40}  color='white'/></a>
                        </div>
                    </div>
                    {/* <div className='d-flex justify-content-center flex-column'>
